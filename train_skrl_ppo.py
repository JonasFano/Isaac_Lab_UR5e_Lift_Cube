...
env = load_isaaclab_env(task_name="UR5e-Lift-Cube-IK")
env.num_envs = 2048
env = wrap_env(env)
...
cfg["mini_batches"] = 2 # 96 * 2048 / 98304
...
cfg["experiment"]["directory"] = "logs/skrl/UR5e-Lift-Cube-IK"
...
cfg_trainer = {"timesteps": 98304, "headless": True}
# cfg_trainer = {"timesteps": 262144000, "headless": True}
