...
def main():
    ...
    run = wandb.init(
        project="rel_ik_sb3_ppo_ur5e_lift_cube_0_05_hand_e_domain_rand_without_friction",
        config=config,
    ...
    # Load env cfg
    task = "UR5e-Hand-E-Domain-Rand-Lift-Cube-IK" # "UR5e-Hand-E-Domain-Rand-Lift-Cube-IK" # "UR5e-Lift-Cube-IK" # "UR5e-Lift-Cube"
