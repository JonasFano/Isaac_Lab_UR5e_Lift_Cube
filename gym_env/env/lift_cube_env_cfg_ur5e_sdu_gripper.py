...
@configclass
class UR5e_SDU_Gripper_LiftCubeSceneCfg(InteractiveSceneCfg):
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        tcp_pose = ObsTerm(
            ...
            params={"gripper_offset": [0.0, 0.0, 0.135], "robot_cfg": SceneEntityCfg("robot", body_names=["wrist_3_link"])},
        )
...
@configclass
class UR5e_SDU_Gripper_LiftCubeEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the lifting environment."""
    # Scene settings
    scene: UR5e_SDU_Gripper_LiftCubeSceneCfg = UR5e_SDU_Gripper_LiftCubeSceneCfg(num_envs=4, env_spacing=2.5)
